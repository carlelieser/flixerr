...
class Header extends React.Component {
    ...
    toggleMenu = e => {
        e.stopPropagation();
        this.props.updateMenu(!this.props.menuActive);
        e.target.style.transform = `rotate(${this.props.menuActive ? "0" : "360"}deg)`;
    }
        ...
        return (
            <div className="app-header">
                <Fade delay={20} distance="20%" spy={this.props.background} bottom>
                    <div className="app-header-bg-real" style={{
                        backgroundImage: `${
                ...
                <div className="app-header-bg">
                    <div className="app-header-title">Flixerr</div>
