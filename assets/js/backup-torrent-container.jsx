...
class BackupTorrents extends Component {
    ...
    handleReload = () => {
        ...
        this
            .props
            .updateMovieTime(this.props.currentTime);
        this
            .props
            .resetClient(true)
            .then((result) => {
        ...
        return (
            <div className='backup-container'>
                ...
                <div className='subtitle'>
                    {this.props.torrents
                        ? `Select from one of the alternative torrents for "${
                    this.props.movie.title}" below.` : "We couldn't find any alternative torrents. Please wait or try again."}
                </div>
                {this.props.torrents
                    ? (
