...
class MovieItem extends React.Component {
    ...
    loadImage = () => {
        this.setState({
            backdrop: `url(${this.props.featured
                ...
                <div className="movie-item" onClick={this.handleMovieClick}>
                    <div className="movie-item-desc">
                        ...
                        <div className="movie-item-summary">
                            {this
                                .props
                                .strip(this.props.movie.overview, 80) + "..."}
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        style={{
                        backgroundImage: `url(https://image.tmdb.org/t/p/${this.props.featured
                            ? 'w300'
                            : 'w92'}${this.props.featured
