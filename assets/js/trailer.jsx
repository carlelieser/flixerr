...
class Trailer extends Component {
    ...
    render() {
        ...
        return (
            <Fade when={url} distance="5%" mountOnEnter unmountOnExit bottom duration={250}>
                <div
                    className={`trailer-container ${url
                    ? ''
                    : 'pointer-events'}`}
                    onClick={this.closeTrailer}>
                    <div className="iframe-container" onClick={this.handleVideoClick}>
